Stubs = {
    ...
    ---@return table
    CreateStubType = function(stubType)
        return { __stub = 'userdata', __tostring = stubType }
    end
}
...
do -- type override
    local oldType = type
    function type(obj)
        local objType = oldType(obj)
        if objType == 'table' then
            local mt = getmetatable(objType)
            if mt ~= nil and mt.__stub then
                return 'userdata'
            end
        end
        return objType
...
do -- enums
    local cache = {} ---@type table<table, table<unknown, table>>

    ---@param type table
    ---@param value unknown
    ---@return table
    function getStubTable(type, value)
        cache[type] = cache[type] or {}
        cache[type][value] = cache[type][value] or setmetatable({ value }, type)
        return cache[type][value]
    end

    ---@param stubType string
    ---@param paramType 'integer'
    function fetchStubSupplier(stubType, paramType)
        local errorMsg = "Stub type: " .. stubType .. " - value param is not of type " .. paramType
        local stubMt = Stubs.CreateStubType(stubType)
        return function(value)
            assert(type(value) == paramType, errorMsg)
            return getStubTable(stubMt, value)
        end
    end

    ConvertRace = fetchStubSupplier('race', 'integer') ---@type fun(value: integer): race
    ConvertAllianceType = fetchStubSupplier('alliancetype', 'integer') ---@type fun(value: integer): alliancetype
    ConvertRacePref = fetchStubSupplier('racepreference', 'integer') ---@type fun(value: integer): racepreference
    ConvertIGameState = fetchStubSupplier('igamestate', 'integer') ---@type fun(value: integer): igamestate
    ConvertFGameState = fetchStubSupplier('fgamestate', 'integer') ---@type fun(value: integer): fgamestate
    ConvertPlayerState = fetchStubSupplier('playerstate', 'integer') ---@type fun(value: integer): playerstate
    ConvertPlayerScore = fetchStubSupplier('playerscore', 'integer') ---@type fun(value: integer): playerscore
    ConvertPlayerGameResult = fetchStubSupplier('playergameresult', 'integer') ---@type fun(value: integer): playergameresult
    ConvertUnitState = fetchStubSupplier('unitstate', 'integer') ---@type fun(value: integer): unitstate
    ConvertAIDifficulty = fetchStubSupplier('aidifficulty', 'integer') ---@type fun(value: integer): aidifficulty
    ConvertGameEvent = fetchStubSupplier('gameevent', 'integer') ---@type fun(value: integer): gameevent
    ConvertPlayerEvent = fetchStubSupplier('playerevent', 'integer') ---@type fun(value: integer): playerevent
    ConvertPlayerUnitEvent = fetchStubSupplier('playerunitevent', 'integer') ---@type fun(value: integer): playerunitevent
    ConvertWidgetEvent = fetchStubSupplier('widgetevent', 'integer') ---@type fun(value: integer): widgetevent
    ConvertDialogEvent = fetchStubSupplier('dialogevent', 'integer') ---@type fun(value: integer): dialogevent
    ConvertUnitEvent = fetchStubSupplier('unitevent', 'integer') ---@type fun(value: integer): unitevent
    ConvertLimitOp = fetchStubSupplier('limitop', 'integer') ---@type fun(value: integer): limitop
    ConvertUnitType = fetchStubSupplier('unittype', 'integer') ---@type fun(value: integer): unittype
    ConvertGameSpeed = fetchStubSupplier('gamespeed', 'integer') ---@type fun(value: integer): gamespeed
    ConvertPlacement = fetchStubSupplier('placement', 'integer') ---@type fun(value: integer): placement
    ConvertStartLocPrio = fetchStubSupplier('startlocprio', 'integer') ---@type fun(value: integer): startlocprio
    ConvertGameDifficulty = fetchStubSupplier('gamedifficulty', 'integer') ---@type fun(value: integer): gamedifficulty
    ConvertGameType = fetchStubSupplier('gametype', 'integer') ---@type fun(value: integer): gametype
    ConvertMapFlag = fetchStubSupplier('mapflag', 'integer') ---@type fun(value: integer): mapflag
    ConvertMapVisibility = fetchStubSupplier('mapvisibility', 'integer') ---@type fun(value: integer): mapvisibility
    ConvertMapSetting = fetchStubSupplier('mapsetting', 'integer') ---@type fun(value: integer): mapsetting
    ConvertMapDensity = fetchStubSupplier('mapdensity', 'integer') ---@type fun(value: integer): mapdensity
    ConvertMapControl = fetchStubSupplier('mapcontrol', 'integer') ---@type fun(value: integer): mapcontrol
    ConvertPlayerColor = fetchStubSupplier('playercolor', 'integer') ---@type fun(value: integer): playercolor
    ConvertPlayerSlotState = fetchStubSupplier('playerslotstate', 'integer') ---@type fun(value: integer): playerslotstate
    ConvertVolumeGroup = fetchStubSupplier('volumegroup', 'integer') ---@type fun(value: integer): volumegroup
    ConvertCameraField = fetchStubSupplier('camerafield', 'integer') ---@type fun(value: integer): camerafield
    ConvertBlendMode = fetchStubSupplier('blendmode', 'integer') ---@type fun(value: integer): blendmode
    ConvertRarityControl = fetchStubSupplier('raritycontrol', 'integer') ---@type fun(value: integer): raritycontrol
    ConvertTexMapFlags = fetchStubSupplier('texmapflags', 'integer') ---@type fun(value: integer): texmapflags
    ConvertFogState = fetchStubSupplier('fogstate', 'integer') ---@type fun(value: integer): fogstate
    ConvertEffectType = fetchStubSupplier('effecttype', 'integer') ---@type fun(value: integer): effecttype
    ConvertVersion = fetchStubSupplier('version', 'integer') ---@type fun(value: integer): version
    ConvertItemType = fetchStubSupplier('itemtype', 'integer') ---@type fun(value: integer): itemtype
    ConvertAttackType = fetchStubSupplier('attacktype', 'integer') ---@type fun(value: integer): attacktype
    ConvertDamageType = fetchStubSupplier('damagetype', 'integer') ---@type fun(value: integer): damagetype
    ConvertWeaponType = fetchStubSupplier('weapontype', 'integer') ---@type fun(value: integer): weapontype
    ConvertSoundType = fetchStubSupplier('soundtype', 'integer') ---@type fun(value: integer): soundtype
    ConvertPathingType = fetchStubSupplier('pathingtype', 'integer') ---@type fun(value: integer): pathingtype
    ConvertMouseButtonType = fetchStubSupplier('mousebuttontype', 'integer') ---@type fun(value: integer): mousebuttontype
    ConvertAnimType = fetchStubSupplier('animtype', 'integer') ---@type fun(value: integer): animtype
    ConvertSubAnimType = fetchStubSupplier('subanimtype', 'integer') ---@type fun(value: integer): subanimtype
    ConvertOriginFrameType = fetchStubSupplier('originframetype', 'integer') ---@type fun(value: integer): originframetype
    ConvertFramePointType = fetchStubSupplier('framepointtype', 'integer') ---@type fun(value: integer): framepointtype
    ConvertTextAlignType = fetchStubSupplier('textaligntype', 'integer') ---@type fun(value: integer): textaligntype
    ConvertFrameEventType = fetchStubSupplier('frameeventtype', 'integer') ---@type fun(value: integer): frameeventtype
    ConvertOsKeyType = fetchStubSupplier('oskeytype', 'integer') ---@type fun(value: integer): oskeytype
    ConvertAbilityIntegerField = fetchStubSupplier('abilityintegerfield', 'integer') ---@type fun(value: integer): abilityintegerfield
    ConvertAbilityRealField = fetchStubSupplier('abilityrealfield', 'integer') ---@type fun(value: integer): abilityrealfield
    ConvertAbilityBooleanField = fetchStubSupplier('abilitybooleanfield', 'integer') ---@type fun(value: integer): abilitybooleanfield
    ConvertAbilityStringField = fetchStubSupplier('abilitystringfield', 'integer') ---@type fun(value: integer): abilitystringfield
    ConvertAbilityIntegerLevelField = fetchStubSupplier('abilityintegerlevelfield', 'integer') ---@type fun(value: integer): abilityintegerlevelfield
    ConvertAbilityRealLevelField = fetchStubSupplier('abilityreallevelfield', 'integer') ---@type fun(value: integer): abilityreallevelfield
    ConvertAbilityBooleanLevelField = fetchStubSupplier('abilitybooleanlevelfield', 'integer') ---@type fun(value: integer): abilitybooleanlevelfield
    ConvertAbilityStringLevelField = fetchStubSupplier('abilitystringlevelfield', 'integer') ---@type fun(value: integer): abilitystringlevelfield
    ConvertAbilityIntegerLevelArrayField = fetchStubSupplier('abilityintegerlevelarrayfield', 'integer') ---@type fun(value: integer): abilityintegerlevelarrayfield
    ConvertAbilityRealLevelArrayField = fetchStubSupplier('abilityreallevelarrayfield', 'integer') ---@type fun(value: integer): abilityreallevelarrayfield
    ConvertAbilityBooleanLevelArrayField = fetchStubSupplier('abilitybooleanlevelarrayfield', 'integer') ---@type fun(value: integer): abilitybooleanlevelarrayfield
    ConvertAbilityStringLevelArrayField = fetchStubSupplier('abilitystringlevelarrayfield', 'integer') ---@type fun(value: integer): abilitystringlevelarrayfield
    ConvertUnitIntegerField = fetchStubSupplier('unitintegerfield', 'integer') ---@type fun(value: integer): unitintegerfield
    ConvertUnitRealField = fetchStubSupplier('unitrealfield', 'integer') ---@type fun(value: integer): unitrealfield
    ConvertUnitBooleanField = fetchStubSupplier('unitbooleanfield', 'integer') ---@type fun(value: integer): unitbooleanfield
    ConvertUnitStringField = fetchStubSupplier('unitstringfield', 'integer') ---@type fun(value: integer): unitstringfield
    ConvertUnitWeaponIntegerField = fetchStubSupplier('unitweaponintegerfield', 'integer') ---@type fun(value: integer): unitweaponintegerfield
    ConvertUnitWeaponRealField = fetchStubSupplier('unitweaponrealfield', 'integer') ---@type fun(value: integer): unitweaponrealfield
    ConvertUnitWeaponBooleanField = fetchStubSupplier('unitweaponbooleanfield', 'integer') ---@type fun(value: integer): unitweaponbooleanfield
    ConvertUnitWeaponStringField = fetchStubSupplier('unitweaponstringfield', 'integer') ---@type fun(value: integer): unitweaponstringfield
    ConvertItemIntegerField = fetchStubSupplier('itemintegerfield', 'integer') ---@type fun(value: integer): itemintegerfield
    ConvertItemRealField = fetchStubSupplier('itemrealfield', 'integer') ---@type fun(value: integer): itemrealfield
    ConvertItemBooleanField = fetchStubSupplier('itembooleanfield', 'integer') ---@type fun(value: integer): itembooleanfield
    ConvertItemStringField = fetchStubSupplier('itemstringfield', 'integer') ---@type fun(value: integer): itemstringfield
    ConvertMoveType = fetchStubSupplier('movetype', 'integer') ---@type fun(value: integer): movetype
    ConvertTargetFlag = fetchStubSupplier('targetflag', 'integer') ---@type fun(value: integer): targetflag
    ConvertArmorType = fetchStubSupplier('armortype', 'integer') ---@type fun(value: integer): armortype
    ConvertHeroAttribute = fetchStubSupplier('heroattribute', 'integer') ---@type fun(value: integer): heroattribute
    ConvertDefenseType = fetchStubSupplier('defensetype', 'integer') ---@type fun(value: integer): defensetype
    ConvertRegenType = fetchStubSupplier('regentype', 'integer') ---@type fun(value: integer): regentype
    ConvertUnitCategory = fetchStubSupplier('unitcategory', 'integer') ---@type fun(value: integer): unitcategory
    ConvertPathingFlag = fetchStubSupplier('pathingflag', 'integer') ---@type fun(value: integer): pathingflag
end

do -- todo: needs some mapping?
...
do --  Math API
    ...
    local nativeSin = math.sin
    ---@param radians number
    function Sin(radians)
        return nativeSin(radians)
    end

    local nativeCos = math.cos
    ---@param radians number
    function Cos(radians)
        return nativeCos(radians)
    end

    local nativeTan = math.tan
    ---@param radians number
    function Tan(radians)
        return nativeTan(radians)
    end

    --  Expect values between -1 and 1...returns 0 for invalid input
    local nativeAsin = math.asin
    ---@param y number
    function Asin(y)
        return nativeAsin(y)
    end

    local nativeAcos = math.acos
    ---@param x number
    function Acos(x)
        return nativeAcos(x)
    end

    local nativeAtan = math.atan
    ---@param x number
    function Atan(x)
        return nativeAtan(x)
    end
    ...
    local nativeSqrt = math.sqrt
    ---@param x number
    function SquareRoot(x)
        return nativeSqrt(x)
    end

    local nativePow = math.pow
    ...
    function MathRound(r)
        if math.abs(r) > ofs then
            return r
        end
        return r < 0 and r - ofs + ofs or r + ofs - ofs
    end
end

do --  String Utility API
    ---@param i integer
    function I2R(i)
        return i * 1.0 -- force float
    end

    ---@param r number
    function R2I(r)
        local prefix = r < 0 and -1 or 1 -- integer division doesn't truncate for negatives, it rounds down
        return prefix * math.tointeger((prefix * r * 10) // 10)
    end

    ---@param i integer
    function I2S(i)
        return tostring(R2I(i)) -- make sure it's an integer
    end

    ---@param r number
    function R2S(r)
        return string.format("%.2f", r) -- wc3 by default gives 2 precision in JASS, iirc
    end
    ...
    function R2SW(r, width, precision)
        return string.format("%" .. I2S(width) .. "." .. I2S(precision) .. "f", r)
    end

    ---@param s string
    function S2I(s)
        return R2I(tonumber(s, 10)) -- make sure it's an integer
    end
    ...
    -- Implementing https://www.hiveworkshop.com/threads/bits-of-interest.213272/
    ---@param a integer
    ---@param b integer
    ---@param c integer
    ...
    -- note Lua arrays start from 1, not 0
    ---@param k integer[]|{n:integer}
    ---@param initVal integer
    local function hash(k, initVal)
        local len = k.n
        local a = 0x9e3779b9 -- golden ratio
        local b = a
        local c = initVal

        while len >= 12 do
            a = a + (k[1] + (k[2] << 8) + (k[3] << 16) + (k[4] << 24));
            b = b + (k[5] + (k[6] << 8) + (k[7] << 16) + (k[8] << 24));
            c = c + (k[9] + (k[10] << 8) + (k[11] << 16) + (k[12] << 24));
            a, b, c = mix(a, b, c)
            k = k + 12
            len = len - 12
        end
        ...
        c = c + k.n
        if len >= 11 then c = c + (k[11] << 24) end
        if len >= 10 then c = c + (k[10] << 16) end
        if len >= 9 then c = c + (k[9] << 8) end
        if len >= 8 then b = b + (k[8] << 24) end
        if len >= 7 then b = b + (k[7] << 16) end
        if len >= 6 then b = b + (k[6] << 8) end
        if len >= 5 then b = b + k[5] end
        if len >= 4 then a = a + (k[4] << 24) end
        if len >= 3 then a = a + (k[3] << 16) end
        if len >= 2 then a = a + (k[2] << 8) end
        if len >= 1 then a = a + k[1] end
        a, b, c = mix(a, b, c)
        return c
    end
    ...
    function StringHash(s)
        ...
        if length > 1024 then
            s = string.sub(s, 1, 1024)
            length = 1024
        end
        local buffer = table.pack(string.byte(s))

        local a, z, fwdSlash = string.byte('a'), string.byte('z'), string.byte('/')
        local bckSlash = string.byte('\\')

        for i, char in ipairs(buffer) do
            if char < a or char > z then
                if char == fwdSlash then
                    buffer[i] = bckSlash
                else
                    buffer[i] = char
                end
    ...
    -- this is supposed to return locale specific string, but it's just an identity function here.
    ---@param source string
    function GetLocalizedString(source)
        return source
    end

    -- supposed to do some weird hotkey mapping, but here's it's just gonna be Ascii conversion
    ---@param source string
    function GetLocalizedHotkey(source)
        return true and string.byte(source) -- return only 1 result
    end
end

do -- set/get pairs
    ---@param defaultValue unknown
    ---@param identifierArgPosition integer?
    ---@return function setter, function getter
    local function generateSetGetStubPair(defaultValue, identifierArgPosition)
        local setter, getter ---@type function, function
        if identifierArgPosition then
            local data = {}
            if identifierArgPosition == 1 then
                setter = function(identifier, value)
                    data[identifier] = value
                end
                getter = function(identifier)
                    return data[identifier] or defaultValue
                end
            end
        else
            local data = nil
    ...
    SetMapName = generateSetGetStubPair('') ---@type fun(name: string)
    SetMapDescription = generateSetGetStubPair('') ---@type fun(description: string)
    SetTeams, GetTeams = generateSetGetStubPair(0) ---@type fun(teams: integer), fun(): integer
    SetPlayers, GetPlayers = generateSetGetStubPair(0) ---@type fun(players: integer), fun(): integer
    SetGameTypeSupported, IsGameTypeSupported = generateSetGetStubPair(true, 1) ---@type fun(whichGameType: gametype, supported: boolean), fun(whichGameType: gametype): boolean
    SetMapFlag, IsMapFlagSet = generateSetGetStubPair(false, 1) ---@type fun(whichMapFlag: mapflag, flag: boolean), fun(whichMapFlag: mapflag): boolean
    SetGamePlacement, GetGamePlacement = generateSetGetStubPair(MAP_PLACEMENT_RANDOM) ---@type fun(density: placement), fun(): placement
    SetGameSpeed, GetGameSpeed = generateSetGetStubPair(MAP_SPEED_FASTEST) ---@type fun(density: gamespeed), fun(): gamespeed
    SetGameDifficulty, GetGameDifficulty = generateSetGetStubPair(MAP_DIFFICULTY_NORMAL) ---@type fun(density: gamedifficulty), fun(): gamedifficulty
    SetResourceDensity, GetResourceDensity = generateSetGetStubPair(MAP_DENSITY_NONE) ---@type fun(density: mapdensity), fun(): mapdensity
    SetCreatureDensity, GetCreatureDensity = generateSetGetStubPair(MAP_DENSITY_NONE) ---@type fun(density: mapdensity), fun(): mapdensity

    function GetGameTypeSelected()
        return GAME_TYPE_MELEE -- change this to some other one if necessary
    end
end

do --  Region and Location API
    ---@class StubLocation: location
    ---@field x number
    ---@field y number
    ---@field z number

    local stubLocationMt = Stubs.CreateStubType('location')
    ...
    function RemoveLocation(whichLocation) end -- noop

    ---@param whichLocation location
    ---@param newX number
    ---@param newY number
    function MoveLocation(whichLocation, newX, newY)
        ---@cast whichLocation StubLocation
        whichLocation.x = newX or 0.00
        whichLocation.y = newY or 0.00
    end

    ---@param whichLocation location
    ---@return number
    function GetLocationX(whichLocation)
        return whichLocation --[[@as StubLocation]].x
    end

    ---@param whichLocation location
    ---@return number
    function GetLocationY(whichLocation)
        return whichLocation --[[@as StubLocation]].y
    end
    ...
    function GetLocationZ(whichLocation)
        return whichLocation --[[@as StubLocation]].z
    end
    ...
    local stubRectMt = Stubs.CreateStubType('rect')

    ---@param rect StubRect
    local function fixSize(rect)
        if rect.minx > rect.maxx then rect.minx, rect.maxx = rect.maxx, rect.minx end
        if rect.miny > rect.maxy then rect.miny, rect.maxy = rect.maxy, rect.miny end
    end
    ...
    function RectFromLoc(min, max)
        local rect = setmetatable({
            minx = min --[[@as StubLocation]].x,
            miny = min --[[@as StubLocation]].y,
            maxx = max --[[@as StubLocation]].x,
            maxy = max --[[@as StubLocation]].y
        }, stubRectMt)
        fixSize(rect)
        return rect
    end
    ...
    function RemoveRect(whichRect) end -- noop
    ...
    function SetRect(whichRect, minx, miny, maxx, maxy)
        ---@cast whichRect StubRect
        whichRect.minx = minx or 0.00
        whichRect.miny = miny or 0.00
        whichRect.maxx = maxx or 0.00
        whichRect.maxy = maxy or 0.00
        fixSize(whichRect)
    end
    ...
    function SetRectFromLoc(whichRect, min, max)
        ---@cast whichRect StubRect
        whichRect.minx = min --[[@as StubLocation]].x or 0.00
        whichRect.miny = min --[[@as StubLocation]].y or 0.00
        whichRect.maxx = max --[[@as StubLocation]].x or 0.00
        whichRect.maxy = max --[[@as StubLocation]].y or 0.00
        fixSize(whichRect)
    end
    ...
    function MoveRectTo(whichRect, newCenterX, newCenterY)
        ---@cast whichRect StubRect
        newCenterX = newCenterX or 0.00
        newCenterY = newCenterY or 0.00
        local sizeXHalf = (whichRect.maxx - whichRect.minx) / 2
        local sizeYHalf = (whichRect.maxy - whichRect.miny) / 2
        whichRect.minx = newCenterX - sizeXHalf
        whichRect.miny = newCenterY - sizeYHalf
        whichRect.maxx = newCenterX + sizeXHalf
        whichRect.maxy = newCenterY + sizeYHalf
    end
    ...
    function MoveRectToLoc(whichRect, newCenterLoc)
        ---@cast whichRect StubRect
        local newCenterX = newCenterLoc --[[@as StubLocation]].x or 0.00
        local newCenterY = newCenterLoc --[[@as StubLocation]].y or 0.00
        local sizeXHalf = (whichRect.maxx - whichRect.minx) / 2
        local sizeYHalf = (whichRect.maxy - whichRect.miny) / 2
        whichRect.minx = newCenterX - sizeXHalf
        whichRect.miny = newCenterY - sizeYHalf
    ...
    function GetRectCenterX(whichRect)
        ---@cast whichRect StubRect
        return whichRect.maxx - whichRect.minx
    end

    ---@param whichRect rect
    function GetRectCenterY(whichRect)
        ---@cast whichRect StubRect
        return whichRect.maxy - whichRect.miny
    end

    ---@param whichRect rect
    function GetRectMinX(whichRect)
        return whichRect --[[@as StubRect]].minx
    end

    ---@param whichRect rect
    function GetRectMinY(whichRect)
        return whichRect --[[@as StubRect]].miny
    end

    ---@param whichRect rect
    function GetRectMaxX(whichRect)
        return whichRect --[[@as StubRect]].maxx
    end

    ---@param whichRect rect
    function GetRectMaxY(whichRect)
        return whichRect --[[@as StubRect]].maxy
    end

    ---@class StubRegion: region

    local stubRegionMt = Stubs.CreateStubType('region')

    ---@return region
    function CreateRegion()
        return setmetatable({}, stubRegionMt)
    end

    ---@param whichRegion region
    function RemoveRegion(whichRegion) end -- noop

    ---@param whichRegion region
    ---@param r rect
    function RegionAddRect(whichRegion, r) end -- noop

    ---@param whichRegion region
    ---@param r rect
    function RegionClearRect(whichRegion, r) end -- noop

    ---@param whichRegion region
    ---@param x number
    ---@param y number
    function RegionAddCell(whichRegion, x, y) end -- noop

    ---@param whichRegion region
    ---@param whichLocation location
    function RegionAddCellAtLoc(whichRegion, whichLocation) end -- noop

    ---@param whichRegion region
    ---@param x number
    ---@param y number
    function RegionClearCell(whichRegion, x, y) end -- noop

    ---@param whichRegion region
    ---@param whichLocation location
    function RegionClearCellAtLoc(whichRegion, whichLocation) end -- noop

    ---@param whichRegion region
    ---@param whichUnit unit
    function IsUnitInRegion(whichRegion, whichUnit) return false end -- noop

    ---@param whichRegion region
    ---@param x number
    ---@param y number
    function IsPointInRegion(whichRegion, x, y) return false end -- noop

    ---@param whichRegion region
    ---@param whichLocation location
    function IsLocationInRegion(whichRegion, whichLocation) return false end -- noop
    ...
    function GetWorldBounds()
        return setmetatable({
            ...
            maxx = 133700.0,
            maxy = 133700.0
        }, stubRectMt) -- haha funny number * 100
    end
end

do -- Start Location API
    local stubStartLocations = {} ---@type StubStartLoc[]

    ---@class StubStartLoc
    ---@field x number
    ---@field y number
    ---@field priorities table<integer, [ integer, startlocprio ]>
    ---@field enemyPriorities table<integer, [ integer, startlocprio ]>

    ---@param startLocId integer
    local function getStartLoc(startLocId)
        local stubStartLoc = stubStartLocations[startLocId] or {}
        stubStartLocations[startLocId] = stubStartLoc
        return stubStartLoc
    end
    ...
    function DefineStartLocation(whichStartLoc, x, y)
        local stubStartLoc = getStartLoc(whichStartLoc)
        stubStartLoc.x = x
        stubStartLoc.y = y
    end
    ...
    function GetStartLocationX(whichStartLocation)
        return getStartLoc(whichStartLocation).x or 0.00
    end

    ---@param whichStartLocation integer
    function GetStartLocationY(whichStartLocation)
        return getStartLoc(whichStartLocation).y or 0.00
    end

    local GetLocationX, GetLocationY, Location = GetLocationX, GetLocationY, Location
    ---@param whichStartLoc integer
    ---@param whichLocation location
    function DefineStartLocationLoc(whichStartLoc, whichLocation)
        DefineStartLocation(whichStartLoc, GetLocationX(whichLocation), GetLocationY(whichLocation))
    end

    ---@param whichStartLocation integer
    function GetStartLocationLoc(whichStartLocation)
        local startLocStub = getStartLoc(whichStartLocation)
        return Location(startLocStub.x or 0.00, startLocStub.y or 0.00)
    end
    ...
    function SetStartLocPrioCount(whichStartLoc, prioSlotCount)
        local stubStartLoc = getStartLoc(whichStartLoc)
        stubStartLoc.priorities = {} -- initialize priority array
    end
    ...
    function SetStartLocPrio(whichStartLoc, prioSlotIndex, otherStartLocIndex, priority)
        local stubStartLoc = getStartLoc(whichStartLoc)
        stubStartLoc.priorities[prioSlotIndex] = { otherStartLocIndex, priority }
    end
    ...
    function GetStartLocPrioSlot(whichStartLoc, prioSlotIndex)
        local stubStartLoc = getStartLoc(whichStartLoc)
        if not stubStartLoc.priorities then return 0 end
        if not stubStartLoc.priorities[prioSlotIndex] then return 0 end
        return stubStartLoc.priorities[prioSlotIndex][1] or 0
    end
    ...
    function GetStartLocPrio(whichStartLoc, prioSlotIndex)
        local stubStartLoc = getStartLoc(whichStartLoc)
        if not stubStartLoc.priorities then return MAP_LOC_PRIO_NOT end
        if not stubStartLoc.priorities[prioSlotIndex] then return MAP_LOC_PRIO_NOT end
        return stubStartLoc.priorities[prioSlotIndex][2] or MAP_LOC_PRIO_NOT
    end
    ...
    function SetEnemyStartLocPrioCount(whichStartLoc, prioSlotCount)
        local stubStartLoc = getStartLoc(whichStartLoc)
        stubStartLoc.enemyPriorities = {} -- initialize priority array
    end
    ...
    function SetEnemyStartLocPrio(whichStartLoc, prioSlotIndex, otherStartLocIndex, priority)
        local stubStartLoc = getStartLoc(whichStartLoc)
        stubStartLoc.enemyPriorities[prioSlotIndex] = { otherStartLocIndex, priority }
    end
end

do -- Player Config API -- requires Player API before
    ---@class StubPlayer: player
    ---@field name string
    ---@field startLocIndex integer
    ---@field forceStartLoc boolean
    ---@field configTeam integer
    ---@field color playercolor
    ---@field controller mapcontrol
    ---@field slotState playerslotstate
    ---@field racePreference racepreference
    ---@field raceSelectable boolean
    ---@field inScoreScreen boolean
    ---@field allianceMatrix table<player, table<alliancetype, boolean>>
    ---@field taxMatrix table<player, table<playerstate, integer>>

    ---@param whichPlayer player
    ---@param startLocIndex integer
    function SetPlayerStartLocation(whichPlayer, startLocIndex)
        whichPlayer --[[@as StubPlayer]].startLocIndex = startLocIndex
        whichPlayer --[[@as StubPlayer]].forceStartLoc = false
    end
    ...
    function ForcePlayerStartLocation(whichPlayer, startLocIndex)
        whichPlayer --[[@as StubPlayer]].startLocIndex = startLocIndex
        whichPlayer --[[@as StubPlayer]].forceStartLoc = true
    end

    ---@param whichPlayer player
    ---@return integer
    function GetPlayerStartLocation(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].startLocIndex or 0
    end

    ---@param whichPlayer player
    ---@param whichTeam integer
    function SetPlayerTeam(whichPlayer, whichTeam)
        whichPlayer --[[@as StubPlayer]].configTeam = whichTeam
    end

    ---@param whichPlayer player
    ---@param color playercolor
    function SetPlayerColor(whichPlayer, color)
        whichPlayer --[[@as StubPlayer]].color = color
    end
    ...
    function SetPlayerAlliance(sourcePlayer, otherPlayer, whichAllianceSetting, value)
        ---@cast sourcePlayer StubPlayer
        local allianceMatrix = sourcePlayer.allianceMatrix or {}
        sourcePlayer.allianceMatrix = allianceMatrix
        local alliances = allianceMatrix[otherPlayer] or {}
        allianceMatrix[otherPlayer] = alliances
        alliances[whichAllianceSetting] = value
    end
    ...
    function SetPlayerTaxRate(sourcePlayer, otherPlayer, whichResource, rate)
        ---@cast sourcePlayer StubPlayer
        local taxMatrix = sourcePlayer.taxMatrix or {}
        sourcePlayer.taxMatrix = taxMatrix
        local taxes = taxMatrix[otherPlayer] or {}
        taxMatrix[otherPlayer] = taxes
        taxes[whichResource] = rate
    end

    ---@param whichPlayer player
    ---@param whichRacePreference racepreference
    function SetPlayerRacePreference(whichPlayer, whichRacePreference)
        whichPlayer --[[@as StubPlayer]].racePreference = whichRacePreference
    end

    ---@param whichPlayer player
    ---@param value boolean
    function SetPlayerRaceSelectable(whichPlayer, value)
        whichPlayer --[[@as StubPlayer]].raceSelectable = value
    end

    ---@param whichPlayer player
    ---@param controlType mapcontrol
    function SetPlayerController(whichPlayer, controlType)
        whichPlayer --[[@as StubPlayer]].controller = controlType
    end

    ---@param whichPlayer player
    ---@param name string
    function SetPlayerName(whichPlayer, name)
        whichPlayer --[[@as StubPlayer]].name = name
    end

    ---@param whichPlayer player
    ---@param flag boolean
    function SetPlayerOnScoreScreen(whichPlayer, flag)
        whichPlayer --[[@as StubPlayer]].inScoreScreen = flag
    end

    ---@param whichPlayer player
    function GetPlayerTeam(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].configTeam or 0
    end

    ---@param whichPlayer player
    function GetPlayerColor(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].color or ConvertPlayerColor(25) -- black
    end

    -- Someone ate the word 'Race' for this native name
    ---@param whichPlayer player
    ---@return boolean
    function GetPlayerSelectable(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].raceSelectable or true
    end

    ---@param whichPlayer player
    function GetPlayerController(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].controller or MAP_CONTROL_NONE
    end

    ---@param whichPlayer player
    function GetPlayerSlotState(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].slotState or PLAYER_SLOT_STATE_EMPTY
    end
    ...
    function GetPlayerTaxRate(sourcePlayer, otherPlayer, whichResource)
        ...
        local taxes = taxMatrix[otherPlayer] or {}
        taxMatrix[otherPlayer] = taxes
        return taxes[whichResource] or 0
    end

    ---@param whichPlayer player
    ---@param pref racepreference
    function IsPlayerRacePrefSet(whichPlayer, pref)
        return whichPlayer --[[@as StubPlayer]].racePreference == pref
    end

    ---@param whichPlayer player
    function GetPlayerName(whichPlayer)
        return whichPlayer --[[@as StubPlayer]].name or ''
    end
end

do --  Timer API
    Stubs.timers = {} ---@type table<StubTimer, true>
    local timerStubMt = Stubs.CreateStubType('timer')
    ...
    function CreateTimer()
        local timer = getStubTable()
        Stubs.timers[timer] = true
        return timer
    end

    ---@param whichTimer timer
    function DestroyTimer(whichTimer)
        Stubs.timers[whichTimer] = nil
    end
    ...
    function TimerGetElapsed(whichTimer)
        return whichTimer --[[@as StubTimer]].elapsed
    end

    ---@param whichTimer timer
    ---@return number
    function TimerGetRemaining(whichTimer)
        return whichTimer --[[@as StubTimer]].remaining
    end

    ---@param whichTimer timer
    function TimerGetTimeout(whichTimer)
        return whichTimer --[[@as StubTimer]].timeout
    end

    ---@param whichTimer timer
    function PauseTimer(whichTimer)
        whichTimer --[[@as StubTimer]].paused = true
    end

    ---@param whichTimer timer
    function ResumeTimer(whichTimer)
        whichTimer --[[@as StubTimer]].paused = false
    end

    -- TODO: needs a thread setup
    ---@return timer
    function GetExpiredTimer() end -- (native)
end

do --  Group API
    local groups = {} ---@type table<group, true>

    ---@class StubGroup: group
    ---@field indexof table<unit, integer>
    ---@field content unit[]
    ---@field size integer

    local stubGroupMt = Stubs.CreateStubType('group')

    ---@return group
    function CreateGroup()
        local group = setmetatable({ indexof = {}, content = {}, size = 0 }, stubGroupMt)
        groups[group] = true
        return group
    end
    ...
    function DestroyGroup(whichGroup)
        groups[whichGroup] = nil
    end

    ---@param whichGroup group
    ---@param whichUnit unit
    function GroupAddUnit(whichGroup, whichUnit)
        ---@cast whichGroup StubGroup
        if whichGroup.indexof[whichUnit] ~= nil then return false end
        whichGroup.size = whichGroup.size + 1
        whichGroup.indexof[whichUnit] = whichGroup.size
        whichGroup.content[whichGroup.size] = whichUnit
        return true
    end
    ...
    function GroupRemoveUnit(whichGroup, whichUnit)
        ---@cast whichGroup StubGroup
        local pos = whichGroup.indexof[whichUnit]
        if pos == nil then return false end
        whichGroup.indexof[whichUnit] = nil
        whichGroup.size = whichGroup.size - 1
        for i = pos, whichGroup.size, 1 do
            local unit = whichGroup.content[i + 1]
            whichGroup.content[i] = unit
            whichGroup.indexof[unit] = i
        end
        whichGroup[whichGroup.size + 1] = nil -- clean the last duplicate
        return true
    end
    ...
    function BlzGroupAddGroupFast(whichGroup, addGroup)
        local counter = 0
        for _, unit in ipairs(whichGroup --[[@as StubGroup]].content) do
            if GroupAddUnit(addGroup, unit) then
                counter = counter + 1
            end
        end
        return counter
    ...
    function BlzGroupRemoveGroupFast(whichGroup, removeGroup)
        local counter = 0
        for _, unit in ipairs(whichGroup --[[@as StubGroup]].content) do
            -- can't be bothered to make an optimal algorithm for this, nor does it matter
            if GroupRemoveUnit(removeGroup, unit) then
                counter = counter + 1
            end
        end
        return counter
    ...
    function BlzGroupGetSize(whichGroup)
        return whichGroup --[[@as StubGroup]].size
    end

    ---@param whichGroup group
    ---@param index integer
    function BlzGroupUnitAt(whichGroup, index)
        return whichGroup --[[@as StubGroup]].content[index]
    end

    ---@param whichGroup group
    ---@param unitname string
    ---@param filter? boolexpr
    function GroupEnumUnitsOfType(whichGroup, unitname, filter) end -- noop

    ---@param whichGroup group
    ---@param whichPlayer player
    ---@param filter? boolexpr
    function GroupEnumUnitsOfPlayer(whichGroup, whichPlayer, filter) end -- noop

    ---@param whichGroup group
    ---@param unitname string
    ---@param filter? boolexpr
    ---@param countLimit integer
    function GroupEnumUnitsOfTypeCounted(whichGroup, unitname, filter, countLimit) end -- noop

    ---@param whichGroup group
    ---@param r rect
    ---@param filter? boolexpr
    function GroupEnumUnitsInRect(whichGroup, r, filter) end -- noop

    ---@param whichGroup group
    ---@param r rect
    ---@param filter? boolexpr
    ---@param countLimit integer
    function GroupEnumUnitsInRectCounted(whichGroup, r, filter, countLimit) end -- noop
    ...
    ---@param radius number
    ---@param filter? boolexpr
    function GroupEnumUnitsInRange(whichGroup, x, y, radius, filter) end -- noop

    ---@param whichGroup group
    ---@param whichLocation location
    ---@param radius number
    ---@param filter? boolexpr
    function GroupEnumUnitsInRangeOfLoc(whichGroup, whichLocation, radius, filter) end -- noop
    ...
    ---@param filter? boolexpr
    ---@param countLimit integer
    function GroupEnumUnitsInRangeCounted(whichGroup, x, y, radius, filter, countLimit) end -- noop
    ...
    ---@param filter? boolexpr
    ---@param countLimit integer
    function GroupEnumUnitsInRangeOfLocCounted(whichGroup, whichLocation, radius, filter, countLimit) end -- noop

    ---@param whichGroup group
    ---@param whichPlayer player
    ---@param filter? boolexpr
    function GroupEnumUnitsSelected(whichGroup, whichPlayer, filter) end -- noop

    ---@param whichGroup group
    ---@param order string
    ---@return boolean
    function GroupImmediateOrder(whichGroup, order) return false end -- noop

    ---@param whichGroup group
    ---@param order integer
    ---@return boolean
    function GroupImmediateOrderById(whichGroup, order) return false end -- noop
    ...
    ---@param y number
    ---@return boolean
    function GroupPointOrder(whichGroup, order, x, y) return false end -- noop

    ---@param whichGroup group
    ---@param order string
    ---@param whichLocation location
    ---@return boolean
    function GroupPointOrderLoc(whichGroup, order, whichLocation) return false end -- noop
    ...
    ---@param y number
    ---@return boolean
    function GroupPointOrderById(whichGroup, order, x, y) return false end -- noop

    ---@param whichGroup group
    ---@param order integer
    ---@param whichLocation location
    ---@return boolean
    function GroupPointOrderByIdLoc(whichGroup, order, whichLocation) return false end -- noop

    ---@param whichGroup group
    ---@param order string
    ---@param targetWidget widget
    ---@return boolean
    function GroupTargetOrder(whichGroup, order, targetWidget) return false end -- noop

    ---@param whichGroup group
    ---@param order integer
    ---@param targetWidget widget
    ---@return boolean
    function GroupTargetOrderById(whichGroup, order, targetWidget) return false end -- noop

    local currentEnumUnit = nil ---@type unit
    ...
    function ForGroup(whichGroup, callback)
        ---@cast whichGroup StubGroup
        local oldEnumUnit = currentEnumUnit
        for i = 1, whichGroup.size do
            local unit = whichGroup.content[i]
            currentEnumUnit = oldEnumUnit
            callback()
            if whichGroup.indexof[unit] == nil then
                i = i - 1
            end
        end
        currentEnumUnit = oldEnumUnit
    ...
    function FirstOfGroup(whichGroup)
        return whichGroup --[[@as StubGroup]].content[1]
    end
end

do --  Force API
    ---@class StubForce: force
    ---@field [integer] player
    ---@field [player] boolean

    local stubForceMt = Stubs.CreateStubType('force')

    ---@return force
    function CreateForce()
        return setmetatable({ size = 0 }, stubForceMt)
    end

    ---@param whichForce force
    function DestroyForce(whichForce) end -- noop

    ---@param whichForce force
    ---@param whichPlayer player
    function ForceAddPlayer(whichForce, whichPlayer)
        ---@cast whichForce StubForce
        whichForce[whichPlayer.id] = whichPlayer
        whichForce[whichPlayer] = true
    end
    ...
    function ForceRemovePlayer(whichForce, whichPlayer)
        ---@cast whichForce StubForce
        whichForce[whichPlayer] = false
    end

    ---@param whichForce force
    ---@param whichPlayer player
    function BlzForceHasPlayer(whichForce, whichPlayer)
        return whichForce --[[@as StubForce]][whichPlayer]
    end

    local maxSlots = GetBJMaxPlayerSlots()

    ---@param whichForce force
    function ForceClear(whichForce)
        ---@cast whichForce StubForce
        for i = 1, maxSlots do
            whichForce[whichForce[i]] = false
        end
    end

    ---@param whichForce force
    ---@param filter? boolexpr
    function ForceEnumPlayers(whichForce, filter) end -- noop

    ---@param whichForce force
    ---@param filter? boolexpr
    ---@param countLimit integer
    function ForceEnumPlayersCounted(whichForce, filter, countLimit) end -- noop

    ---@param whichForce force
    ---@param whichPlayer player
    ---@param filter? boolexpr
    function ForceEnumAllies(whichForce, whichPlayer, filter) end -- noop

    ---@param whichForce force
    ---@param whichPlayer player
    ---@param filter? boolexpr
    function ForceEnumEnemies(whichForce, whichPlayer, filter) end -- noop

    local currentEnumPlayer = nil ---@type player
    ...
    function ForForce(whichForce, callback)
        ---@cast whichForce StubForce
        local oldEnumPlayer = currentEnumPlayer
        for i = 1, maxSlots do
            currentEnumPLayer = whichForce[i]
            callback()
        end
        currentEnumPlayer = oldEnumPlayer
    end
end
...
do                                 -- boolexprs
    ---@class StubBoolexpr: boolexpr
    ---@field code fun(): boolean

    ---@class StubFilterfunc: StubBoolexpr, filterfunc
    ---@class StubConditionfunc: StubBoolexpr, conditionfunc

    local boolexprMt = Stubs.CreateStubType('boolexpr')
    local filterMt = Stubs.CreateStubType('filterfunc')
    local conditionMt = Stubs.CreateStubType('conditionfunc')
    ...
    function And(operandA, operandB)
        return setmetatable({
            code = function()
                return operandA --[[@as StubBoolexpr]].code() and operandB --[[@as StubBoolexpr]].code()
            end
        }, boolexprMt) --[[@as boolexpr]]
    end
    ...
    function Or(operandA, operandB)
        return setmetatable({
            code = function()
                return operandA --[[@as StubBoolexpr]].code() or operandB --[[@as StubBoolexpr]].code()
            end
        }, boolexprMt) --[[@as boolexpr]]
    end
    ...
    function Not(operand)
        return setmetatable({
            code = function()
                return not operand --[[@as StubBoolexpr]].code()
            end
        }, boolexprMt) --[[@as boolexpr]]
    end
    ...
    function Condition(func)
        return setmetatable({ code = func }, conditionMt)
    end

    ---@param c conditionfunc
    function DestroyCondition(c) end -- does nothing

    ---@param func function
    ---@return filterfunc
    function Filter(func)
        return setmetatable({ code = func, filterMt })
    end

    ---@param f filterfunc
    function DestroyFilter(f) end -- does nothing

    ---@param e? boolexpr
    function DestroyBoolExpr(e) end -- does nothing
end
...
do                                            --  Widget API
    ...
    ---@field y number
    ---@field z number
    ---@field collisionSize number
    ---@field health number
    ---@field maxHealth number
    ---@field facing number

    local WidgetStub = Stubs.CreateStubType('widget')

    ---@param whichWidget widget
    ---@return number
    function GetWidgetLife(whichWidget)
        if whichWidget == nil then return 0 end
        return whichWidget --[[@as WidgetStub]].health
    end

    ---@param whichWidget widget
    ---@param newLife number
    function SetWidgetLife(whichWidget, newLife)
        if whichWidget == nil then return end
        if newLife == nil then return end
        whichWidget --[[@as WidgetStub]].health = math.max(0, newLife)
    end

    ---@param whichWidget widget
    ---@return number
    function GetWidgetX(whichWidget)
        if whichWidget == nil then return 0.00 end
        return whichWidget --[[@as WidgetStub]].x
    end
    ...
    function GetWidgetY(whichWidget)
        if whichWidget == nil then return 0.00 end
        return whichWidget --[[@as WidgetStub]].y
    end

    ---@return widget
    function GetTriggerWidget() end -- (native) -- TODO
end

do -- Destructable API --  Facing arguments are specified in degrees
    ---@class DestructableStub: destructable, WidgetStub
    ---@field scale number
    ---@field variation integer
    ---@field dead boolean
    ---@field invulnerable boolean
    
    local destructableStubMt = Stubs.CreateStubType('destructable')
    ---@param objectId integer
    ---@param x number
    ---@param y number
    ---@param z number
    ...
    ---@param dead boolean
    ---@return DestructableStub
    local function create(objectId, x, y, z, face, scale, variation, dead)
        ...
        if variation == nil then return nil end
        if dead == nil then return nil end
        return setmetatable({
            x = x, y = y, z = z, face = face, scale = scale, variation = variation, dead = dead, invulnerable = false
        }, destructableStubMt)
    end
    ...
    function CreateDestructable(objectid, x, y, face, scale, variation)
        return create(objectid, x, y, 0, face, scale, variation, false)
    end
    ...
    function CreateDestructableZ(objectid, x, y, z, face, scale, variation)
        return create(objectid, x, y, z, face, scale, variation, false)
    end
    ...
    function CreateDeadDestructable(objectid, x, y, face, scale, variation)
        return create(objectid, x, y, 0, face, scale, variation, true)
    end
    ...
    function CreateDeadDestructableZ(objectid, x, y, z, face, scale, variation)
        return create(objectid, x, y, z, face, scale, variation, true)
    end

    ---@param d destructable
    function RemoveDestructable(d) end -- todo: ??

    ---@param d destructable
    function KillDestructable(d)
        if d == nil then return end
        ---@cast d DestructableStub
        d.dead = true
        d.health = 0.00
    end
    ...
    function SetDestructableInvulnerable(d, flag)
        ...
        d--[[@as DestructableStub]].invulnerable = flag
    end
    ...
    function IsDestructableInvulnerable(d)
        ...
        return d--[[@as DestructableStub]].invulnerable
    end
...
function BlzCameraSetupApplyForceDurationSmooth(whichSetup, doPan, forcedDuration, easeInDuration, easeOutDuration,
                                                smoothFactor)
end -- (native)
